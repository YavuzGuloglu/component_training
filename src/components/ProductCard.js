            ...
            <div className='div-img'>
                {sponsored && <div className='sponsored-div'><Info className="m-r" /> Sponsorlu ürün</div>}
                {
                    data?.thumbnail ?
                        ...
                        :
                        <div className='img-empty'><AddImage className='empty-icon' /> Ürün görseli henüz eklenmemiştir</div>
                }
                {
                ...
                }
                {
                    ...
                    <div className={clickEvent?.bell ? 'bell-div click' : 'bell-div'} onClick={() => handleClickEvent('bell')}>
                        <Bell className={clickEvent?.bell ? 'bell-button-click' : 'bell-button'} />
                    </div>
                }
